...
for(const test of cases){
 const runtime=structuredClone(original),installed={base_files:prepared.base_driver_files,effective_files:structuredClone(prepared.effective_driver_files),driver_scope_sha256:prepared.driver_scope_sha256,uid:10001,directory:'/results/driver-accounting-s13-r1'};
