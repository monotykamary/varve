...
const variables={varve:{VARVE_DATA_DIR:'/data/probes/scoped-0bj4bw',VARVE_BENCH_CONFIG:readFileSync(root+'/benchmark-config.json','utf8').trim()},timescale:{PGDATA:'/var/lib/postgresql/data/scoped-0bj4bw'}};
...
console.log(JSON.stringify({configured:completed,readback_verified:true,original_unchanged:true,compute_started:false,explicit_format:'v2 opt-in',derived_budget_bytes:536870912,fresh_directory_suffix:'scoped-0bj4bw'}));
