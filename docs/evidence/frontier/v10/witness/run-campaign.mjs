...
const execute=promisify(execFile),root='/tmp/varve-scoped.0bj4bw';
...
try{
  ...
  await workload('scoped001','baseline',1200,'baseline');
  await workload('scoped002','stress',600,'stress');
  await Promise.all([
