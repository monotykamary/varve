...
const receipts=['before.json','prepared.json','staged.json','source-manifest.json','stage/SOURCE_MANIFEST.json','source.tar.gz','runtime-config.json','benchmark-config.json','driver-scope.json','driver-diagnostic-tests.log','DIAGNOSTIC_REVIEW.md','REVIEW_RESOLUTION.md','summary-tests.json','installer-tests.json','attestation-tests.json','cleanup-tests.json','control-tests.json','varve-tests.json','probe-varve-tests.json','ownership-tests.json','configuration-tests.json','analysis-tests.json'];
...
if(process.argv.includes('--check')){
 ...
 for(const name of ['configured.json','configuration-intent.json','configuration-progress.json','upload-varve.jsonl','redeploy-intent.json','redeployed.json','runtime-varve.json','runtime-driver.json','runtime-driver-effective.json','campaign-started.json','campaign-complete.json','campaign-error.json','cleanup-request.json','cleanup-response.json','cleanup-verified.json','status-latest.json','acct001.json','acct002.json'])assert(!existsSync(root+'/'+name),'Unexpected activation receipt: '+name);
