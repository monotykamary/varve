...
assert result['source_manifest_sha256']=='ab8c46ad7670557d2abe93b702658484d44a09f88068bdd93801708dfd146a5a'
...
assert result['data_dir']=='/data/probes/prefix-2q0icf'
assert result['cpu_max']=='200000 100000' and int(result['memory_max'])==1999998976
assert len(api('GET','/v1/tables'))==1, 'Expected only the preserved baseline table'
...
assert result['status']['fenced'] is None
result['resume_scope']='retained baseline after controller abort; not a fresh empty database'
