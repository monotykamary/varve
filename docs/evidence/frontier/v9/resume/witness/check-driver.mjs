...
console.log(JSON.stringify({driver_files_identical:true,python_identical:true,postgres_version_identical:true,extension_version:runtime.postgres[3],retained_postgres:true,durability:'fsync/on, synchronous_commit/on, full_page_writes/on',resources_identical:true}));
