...
if(!buildOnly&&!aborting)for(const id of ['diag101','diag102']){const report=JSON.parse(readFileSync(root+'/'+id+'.json','utf8'));if(!report.finished_at)throw Error('Workload unfinished');}
