...
const root='/tmp/varve-diagnostic.KOUrtH',repo='/Users/monotykamary/VCS/working-remote/open-source/varve',base=repo+'/docs/evidence/frontier/v10';
...
writeFileSync(root+'/benchmark-config.json',JSON.stringify(JSON.parse(config))+'\n',{mode:0o600});
