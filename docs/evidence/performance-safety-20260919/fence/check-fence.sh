...
gate() {
  test "$(sha256sum "$e/source-files.sha256" | cut -c1-64)" = 6f9a1f288089082f010a5d74f9a8463d4c6d376b2a9ba5be3216a5c72e351c60
  ...
  diff -u "$e/source-files.txt" "$e/$name.paths-$1.txt"
}
