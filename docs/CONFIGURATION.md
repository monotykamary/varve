...
| `duckdb_library` | `null` | Absolute path to the exact checksum-pinned DuckDB v2 shared library. Activates native shared-batch SQL with private per-query environments; currently qualified on Linux x86_64/x86-64-v3. No automatic CLI fallback. |
